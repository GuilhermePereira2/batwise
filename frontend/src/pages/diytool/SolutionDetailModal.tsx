...
export const SolutionDetailModal = ({ solution, isOpen, onClose, showComponents, dataSource }: SolutionDetailModalProps) => {
  ...
  const downloadDatasheet_txt = () => {
    // Mantido vazio conforme pedido no turno anterior para brevidade, ou pode reintroduzir a lógica se necessário
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        {/* --- VISUALIZATIONS SECTION (VERTICAL STACK: 3D TOP, DIAGRAM BOTTOM) --- */}
        {showComponents && (
          <div className="flex flex-col gap-6 mt-6">

            {/* 1. 3D MODEL VIEWER (TOP) */}
            <div>
              <Button
                variant="outline"
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  {show3D ? "Hide 3D Model" : "Show 3D Model"}
                </span>
              ...
              {show3D && (
                <div className="mt-4 animate-in fade-in zoom-in-95 duration-300">
                  ...
                  <p className="text-xs text-center text-muted-foreground mt-2">
                    Interactive 3D view based on calculated geometry.
                    <br />Left click to rotate, Right click to pan, Scroll to zoom.
                  </p>
                </div>
              )}
            </div>

            {/* 2. WIRING DIAGRAM (BOTTOM) */}
            <div>
              <Button
                variant="outline"
