...
case $CHOICE in
  ...
  2)
    ...
    echo ""
    echo "O backend usa a conta AWS default configurada no computador."
    echo "Se quiseres forçar um perfil, exporta AWS_PROFILE na shell antes de iniciar."
    ...
    echo ""
    echo "Também podes usar AWS_ACCESS_KEY_ID/AWS_SECRET_ACCESS_KEY no ambiente."
    echo ""
    echo "Depois:"
