...
import { ArrowLeft, Battery, Zap, Scale, ExternalLink, Loader2 } from "lucide-react";
import { getApiUrl } from "@/lib/config";
import { createCellSlug } from "@/lib/utils";
import { useToast } from "@/hooks/use-toast";

// Interface igual à do Explorer (idealmente devia estar num ficheiro types.ts partilhado)
interface Cell {
    Brand: string;
    CellModelNo: string;
    Composition: string;
...
const CellDetails = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <main className="flex-grow pt-32 pb-16 container px-4 mx-auto max-w-5xl">
